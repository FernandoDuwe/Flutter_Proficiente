...
mixin _$CurrentUserStore on _CurrentUserStore, Store {
  ...
  late final _$_CurrentUserStoreActionController =
      ActionController(name: '_CurrentUserStore', context: context);

  @override
  void setUserFromObject(UserModel prUser) {
    final _$actionInfo = _$_CurrentUserStoreActionController.startAction(
        name: '_CurrentUserStore.setUserFromObject');
    try {
      return super.setUserFromObject(prUser);
    } finally {
      _$_CurrentUserStoreActionController.endAction(_$actionInfo);
    }
  }
